...
<%
  ...
  ResultSet rs = rel.relatorioProduto();
                if (rs.next()) {
                    rs.beforeFirst();


String caminho = "C:/Users/user/Documents/Escola/Desenvolvimento para WEB/Sorveteria/web/relatorios/RelatorioProduto.jasper";
...
<jsp:forward page="Mensagem.jsp">
    <jsp:param name="mensagem" value="Não há produto cadastrado, para cadastrar um produto clique no menu CADASTRO > Funcionário." />
</jsp:forward>

...
<%
  ...
  ResultSet rs = rel.relatorioCompra();
                if (rs.next()) {
                    rs.beforeFirst();


String caminho = "C:/Users/user/Documents/Escola/Desenvolvimento para WEB/Sorveteria/web/relatorios/RelatorioCompra.jasper";
...
<jsp:forward page="Mensagem.jsp">
    <jsp:param name="mensagem" value="Não há compras cadastrado, para cadastrar um compras clique no menu CADASTRO > Funcionário." />
</jsp:forward>

...
String caminho = "C:/Users/user/Documents/Escola/Desenvolvimento para WEB/Sorveteria/web/relatorios/RelatorioCliente.jasper";
...
<jsp:forward page="Mensagem.jsp">
    <jsp:param name="mensagem" value="Não há cliente cadastrado, para cadastrar um cliente clique no menu CADASTRO > Funcionário." />
</jsp:forward>

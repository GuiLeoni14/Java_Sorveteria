...
String caminho = "C:/Users/user/Documents/Escola/Desenvolvimento para WEB/Sorveteria/web/relatorios/RelatorioVenda.jasper";
...
<jsp:forward page="Mensagem.jsp">
    <jsp:param name="mensagem" value="Não há vendas cadastrado, para cadastrar um vendas clique no menu CADASTRO > Funcionário." />
</jsp:forward>

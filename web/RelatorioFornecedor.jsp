<%--
    Document   : RelatorioFornecedorrOld
...
<%
  ...
  ResultSet rs = rel.relatorioFornecedor();
                if (rs.next()) {
                    rs.beforeFirst();


String caminho = "C:/Users/user/Documents/Escola/Desenvolvimento para WEB/Sorveteria/web/relatorios/RelatorioFornecedor.jasper";
...
<jsp:forward page="Mensagem.jsp">
    <jsp:param name="mensagem" value="Não há fornecedor cadastrado, para cadastrar um fornecedor clique no menu CADASTRO > Funcionário." />
</jsp:forward>
